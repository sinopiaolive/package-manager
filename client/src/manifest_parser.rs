...
mod test {
    ...
    fn manifest_parser() {
        assert_eq!(
            ...
            Ok(Manifest {
                entries: vec![
                    ManifestEntry::WsOrComment(WsOrComment {
                        ws: "",
                        comment: "",
                    }),
                ],
            ...
            Ok(Manifest {
                entries: vec![
                    ...
                    ManifestEntry::Dependencies(Dependencies {
                        opening_line: "  dependencies {",
                        entries: vec![
                            DependenciesEntry::DependencyLine(DependencyLine {
                                prefix_ws: " ",
                                body_source: "js/left-pad: ^3.4.0",
                                body: DependencyBody {
                                    package_name: "js/left-pad",
                                    version_constraint_component1: "^3.4.0",
                                    version_constraint_component2: None,
                                },
                                suffix_ws: " // yay",
                            }),
                        ],
